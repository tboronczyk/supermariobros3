...
dd if=chr/pause-ux.bin of="$ROM" conv=notrunc bs=1 seek=$((0x4CBB0))
dd if=chr/pause-zo.bin of="$ROM" conv=notrunc bs=1 seek=$((0x4CBD0))
...
dd if=chr/info-j.bin of="$ROM" conv=notrunc bs=1 seek=$((0x45FC0))
dd if=chr/info-excl.bin of="$ROM" conv=notrunc bs=1 seek=$((0x45FE0))
